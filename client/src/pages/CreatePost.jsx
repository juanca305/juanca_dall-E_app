...
const CreatePost = () => {
  //Navigate back to the Home page once the post is created.
  ...
  //Used while making contact with the API.
  ...
  const handleSubmit = async (e) => {
    // Doesn't allow the browser automatically reload tha app.
    e.preventDefault();
    ...
    <section className='max-w-7xl mx-auto'>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-5 flex gap-5'>
              {/* This button is going to call the Back End*/}
              <button
                type='button'
